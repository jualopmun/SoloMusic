	...
	<div class="container">
			...
			<div class="form-group" >
				<form:errors path="*" class="has-error" />
					...
					<br />
					<input class="form-control" value="${perfomance.title}"
					...
					<br />
			 		...
			 		<label><spring:message code="perfomance.videoUrl" /></label>
			 		<br />
			 		
			 		<input class="form-control" value="${perfomance.videoUrl}"
				...
				<input onclick="window.location='perfomance/user/view.do?p=${actor.userSpace.id}'" class="btn btn-danger" type="button" name="cancel" value="${actorCancelHeader}"/>
